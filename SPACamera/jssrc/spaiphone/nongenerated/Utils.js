		...
		function fileBrowse(browseConfig) {
		    ...
		    if (browseConfig.selectMultipleFiles == false) fileElement.removeAttribute("multiple");
		    else fileElement.setAttribute("multiple", "multiple");
		    if (browseConfig.filter) fileElement.setAttribute("accept", browseConfig.filter.join(","));
		    else fileElement.removeAttribute("accept");
		    fileElement.click();
		}
